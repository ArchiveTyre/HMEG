...
DivButtonList.prototype = Object.create(DivButton.prototype);
...
{	
	DivButton.call(this, parent, divId, divName); // call super constructor
	this.buttonTexts=buttonTexts;
	this.headingText=headingText;

	for (i=0;i<buttonTexts.length;i++)
	{
		this.children[i]=new DivButton(this, i, hlibRemoveQuotes(buttonTexts[i]));
